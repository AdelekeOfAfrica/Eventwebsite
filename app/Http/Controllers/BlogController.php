...
//         // Wrap each sentence in <p> tags and concatenate
//         $formattedContent = '';
//         foreach ($sentences as $sentence) {
//             $formattedContent .= '<p>' . trim($sentence) . '</p>';
//         }
...
//             $blogPost->image_path = $imagePath; // Update the main image path in the database
//         }
